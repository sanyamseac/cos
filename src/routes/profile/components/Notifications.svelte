...
>
    ...
    <div class="space-y-4">
        <div class="flex items-center justify-between">
            <div>
                <p class="font-medium text-gray-800 dark:text-white">Important Email Notifications</p>
            ...
            <form method="post" action="profile?/updateEmailPreference" use:enhance>
                <input type="hidden" name="emailPreference" value={emailNotifs ? 'all' : 'important'} />
                <Switch.Root
                    ...
                    onclick={(e) => setTimeout(() => (e.target as HTMLInputElement).form?.requestSubmit(), 500)}
                >
                    <Switch.Thumb
