				...
				<div class="flex flex-col items-center gap-6 py-4">
					<div class="grid w-full grid-cols-2 gap-6">
						<div class="flex flex-col items-center gap-3">
							...
							<div
								class="flex h-20 w-20 items-center justify-center overflow-hidden rounded-xl bg-gradient-to-br from-gray-200 to-gray-300 dark:from-gray-600 dark:to-gray-700"
							>
					...
					<div class="flex flex-col gap-2 w-full">
						<input
							...
							class="block w-full rounded-lg border border-gray-400 p-3 text-sm text-gray-600 file:mr-4 file:cursor-pointer file:rounded-lg file:border-0 file:bg-green-600 file:px-4 file:py-2 file:text-sm file:font-semibold file:text-white hover:file:from-indigo-600 hover:file:to-purple-700 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400"
						/>
						<div class="text-xs text-gray-500 dark:text-gray-400">
							Supports all image types up to 10MB
						</div>
					</div>
						...
						<div class="grid grid-cols-4 gap-3">
							{#each avatarUrls as avatarUrl, i}
								<Button.Root
									...
									class="h-14 w-14 overflow-hidden rounded-xl ring-2 ring-transparent transition-all duration-200 hover:scale-105 hover:ring-gray-300 dark:hover:ring-gray-600 {selectedAvatarIndex ===
									i
