...
<div>
    <div
        class="h-min-[100%] mb-4 flex items-center justify-between pb-4"
    >
        <div>
        ...
        >
            ...
            <div class="flex flex-col gap-2 sm:flex-row sm:items-end">
                ...
                <button
                    ...
                    class="w-full rounded-lg text-white bg-green-500 dark:bg-green-600 px-4 mt-4 py-2 font-medium transition-all hover:bg-green-700 disabled:cursor-not-allowed disabled:opacity-50 sm:w-auto"
                >
                    {canteenGroup.canteen.open
                        ? allItemsAvailable
                            ? paymentMethod
